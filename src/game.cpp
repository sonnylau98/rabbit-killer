...
Game::Game()
    : m_window(sf::VideoMode(viewSize.x, viewSize.y), "Chicken Bro", sf::Style::Default),
      m_hero(heroTexturesRight, heroTexturesLeft, sf::Vector2f(viewSize.x * 0.25f, viewSize.y * 0.25f), 200)
{
